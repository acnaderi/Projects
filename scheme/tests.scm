...
(begin (print 45) (print 5))
; expect 45;5

(cond ((or 5 True) 8) ((and True) 3))
; expect 8
...
(cond ((> 10 8) (+ 9 2)) else 'Incorrect)
; expect 11

(cond ((> 7 8) (+ 9 2)) (else 'Incorrect))
; expect incorrect

(lambda (b c) (* b 3) (- a 1) (/ b c))
; expect (lambda (b c) (* b 3) (- a 1) (/ b c))
